...
public class Controller {
    ...
    /**
     * Основное меню. Происходит выбор
     * варианта действия над масивом
     * Персон клиники пользователем,
    ...
    /**
     * Получение числа служащего для
     * определения выбора
     * пользователя.
     * @return Возвращает число полученное от
     * пользователя с консоли, если
